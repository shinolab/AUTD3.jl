...
const dll_name = joinpath(@__DIR__, "dll", "autd3capi.dll")
...
autd_start_stm(handle_ptr, freq) = ccall((:AUTDStartSTModulation, dll_name), Cvoid, (Ptr{Cvoid}, Float64), handle_ptr, freq)
