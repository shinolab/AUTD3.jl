...
autd_calibrate_modulation(handle_ptr) = ccall((:AUTDCalibrateModulation, _dll_name), Cvoid, (Ptr{Cvoid},), handle_ptr)
...
autd_append_gain_sync(handle_ptr, gain_ptr) = ccall((:AUTDAppendGainSync, _dll_name), Cvoid, (Ptr{Cvoid}, Ptr{Cvoid}), handle_ptr, gain_ptr)
